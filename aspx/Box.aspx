					...
					<tbody>
						<div class="Box-item" id="Box-item1">
							<tr class="info" >
								...
								<td>
									<label class="" id="Xiaoji" onload="Counter();"></label>￥
								</td>
								<td>
									<button type="button" class="btn btn-success  btn-sm" id="Box-item1" onclick="removeitem();"><span class="iconfont  icon-lajixiang  " id="Box-item1"></span></button>
