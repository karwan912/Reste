<%@ Page Language="C#" AutoEventWireup="true" CodeFile="drawback.aspx.cs" Inherits="aspx_drawback" %>
...
<div class="typo codes img-bg-login">
	<div class="container"> 
		<h3 class="agileits-title">退款退货</h3>


		<div class="row ">
			<div class="col-md-4"></div>
			<div class="col-md-5 boxcont1">
				<form action="" method="">
					
					<div class="boxcont2">
						退款商品： <img  class="img-style2 img-circle" src="../images/15.jpg"  alt="Cinque Terre">   &nbsp;&nbsp;&nbsp;&nbsp; <label class="" id=""> 商品名称:Alimjan Yasin</label>
					</div>
					<div class="">
						...
						<div class="boxcont2">
							<label><input type="radio" name="optionsRadios" id="optionsRadios1" value="radio1" checked="">多拍/拍错/不想要</label>
						</div>
						<div class="boxcont2">
							<label><input type="radio" name="optionsRadios" id="optionsRadios2" value="radio2">缺货</label>
						</div>
						<div class="boxcont2">
							<label><input type="radio" name="optionsRadios" id="optionsRadios3" value="radio3">商品质量问题</label>
						</div>
						<div class="boxcont2">
							<label><input type="radio" name="optionsRadios" id="optionsRadios4" value="radio4">不想要</label>
						</div>
					...
					<div class="">
						...
						<div class="form-group">
							<label for="comment">	退款说明：</label>
							<textarea class="form-control" rows="5" id="comment"></textarea>
						</div>
					</div>
					<div class="">
						图片上传： <input type="file" name="">
					</div>
					<div>
