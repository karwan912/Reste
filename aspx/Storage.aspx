<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Storage.aspx.cs" Inherits="aspx_Storage" %>
...
<div class="typo codes img-bg-login">
	<div class="container"> 
		<h3 class="agileits-title">商品入库</h3>
        ...
        <div class="row">
            ...
            <div class="col-md-8">
                ...
                <div>
                    <form action="Storage.aspx" method="post">
