<%@ Page Language="C#" AutoEventWireup="true" CodeFile="personal.aspx.cs" Inherits="aspx_personal" %>
	...
	<div class="container"> 
		...
		<div class="row">
			...
			<div class="col-md-5">
					...
					<div class="divstyle">
						<input type="submit" name="提交" class="btn btn-success" id="">
					</div>
				</form>

				<div class="divstyle float-right">
						<button class="btn btn-warning" onclick="changpass();" id="">修改  登陆/支付  密码</button>
					</div>
			</div>
