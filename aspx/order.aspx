				...
				<ul class="nav navbar-nav">
					...
					<li class="w3pages"><a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">我的 <span class="caret"></span></a>
						<ul class="dropdown-menu">
							...
							<li><a href="personal.v">个人信息</a></li>
	...
	<div class="container"> 
		...
		<div class="row">
			...
			<div class="col-md-8">
				...
				<div id="product1" class="collapse in">
					<div>
						【 <label class="datestyle" id="time" >2019-03-21 15:32:25</label> 】 &nbsp;&nbsp;&nbsp;&nbsp;  <label class="datestyle" id="">从深圳出发到乌鲁木齐</label>
					</div>
					<div>
						【 <label class="datestyle" id="time" >2019-03-21 15:32:25</label> 】 &nbsp;&nbsp;&nbsp;&nbsp;  <label class="datestyle" id="">从深圳出发到乌鲁木齐</label>
					</div>
				...
				<div id="product2" class="collapse in">
					<div>
						【 <label class="datestyle" id="time" >2019-03-21 15:32:25</label> 】 &nbsp;&nbsp;&nbsp;&nbsp;  <label class="datestyle" id="">从深圳出发到乌鲁木齐</label>
					</div>
					<div>
