<%@ Page Language="C#" AutoEventWireup="true" CodeFile="mail.aspx.cs" Inherits="aspx_mail" %>
			...
			<div class="agile_mail_grids">
				<div class="col-md-5 contact-left">
					...
					<p>南山区深南大道科技园888号
						<span>中国.深圳</span></p>
					<ul>
						<li>企业热线 :400 288 2828 288</li>
						<li>办公室 :0755-28651235</li>
						<li>传真 :0755-28652135</li>
						<li><a href="mailto:info@example.com">A_Yasin@163.com</a></li>
					</ul>
				</div>
				<div class="col-md-7 contact-left">
					...
					<form action="#" method="post">
						...
						<input type="text" name="Telephone" placeholder="您的联系方式" required="">
