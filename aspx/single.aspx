	...
	<div class="container">
		<div class="col-md-4 single-left">
			<div class="flexslider">
				<ul class="slides">
					<li runat="server"  id="Photo1a" data-thumb="../images/a.jpg">
						<div class="thumb-image"> <img runat="server"  id="Photo1b"  src="../images/a.jpg" data-imagezoom="true" class="img-responsive" alt=""> </div>
					</li>
					<li runat="server"  id="Photo2a" data-thumb="../images/b.jpg">
						<div class="thumb-image"> <img  runat="server"  id="Photo2b" src="../images/b.jpg" data-imagezoom="true" class="img-responsive" alt=""> </div>
					</li>
					<li runat="server"  id="Photo3a" data-thumb="../images/c.jpg">
						<div class="thumb-image"> <img  runat="server"   id="Photo3b"  src="../images/c.jpg" data-imagezoom="true" class="img-responsive" alt=""> </div>
					</li> 
				</ul>
			</div>
			<!-- flexslider -->
				...
				<li>
					<div class="w3l_related_products_grid">
						<div class="agile_ecommerce_tab_left mobiles_grid">
							...
							<div class="simpleCart_shelfItem"> 
								<p class="flexisel_ecommerce_cart"><span>799￥</span> <i class="item_price">599￥</i></p>
				...
				<li>
					<div class="w3l_related_products_grid">
						<div class="agile_ecommerce_tab_left mobiles_grid">
							...
							<div class="simpleCart_shelfItem">
								<p class="flexisel_ecommerce_cart"><span>2999￥</span> <i class="item_price">2799￥</i></p>
								<form action="InsertBox.aspx" method="post">
				...
				<li>
					<div class="w3l_related_products_grid">
						<div class="agile_ecommerce_tab_left mobiles_grid">
							...
							<h5><a href="single.aspx" onclick="addCookie();" id="10">格力浦洗碗机</a></h5>
							<div class="simpleCart_shelfItem">
								<p class="flexisel_ecommerce_cart"><span>4599￥</span> <i class="item_price">4399￥</i></p>
								<form action="InsertBox.aspx" method="post">
